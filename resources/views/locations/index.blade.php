    ...
    <div class="row" id="goToAll">
        <div class="col-lg-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title">All Locations</h4>
                ...
                <table id="datatable-history-buttons" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    @foreach($resources as $resource)
                        <tr>
                            ...
                            <td>
                                @if (\App\User::hasAuthority('edit.locations'))
                                <a href="{{ route('locations.edit', [$resource->uuid]) }}"
                                   class="update-modal btn btn-sm btn-success">
                                    <i class="fa fa-edit"></i>
                                </a>
                                @endif

                                @if (\App\User::hasAuthority('delete.locations'))
                                <a href="{{ route('locations.destroy', [$resource->uuid]) }}"
